...
# /home/zhangyu/public_models/llama3_8b_instruct
# /data/zhaoxin/pretrain_models/llama3_8b_instruct
VISION_MODEL=/home/zhangyu/public_models/models--openai--clip-vit-large-patch14
LLM=/home/zhangyu/public_models/llama3_8b_instruct #/data/zhangyu/own_data/public_models/Llama-2-7b-hf
...
DATE=05-09
DATA_PATH=/home/zhangyu-data/ds-mm-gcn-data
...
OUTPUT_Base=/home/zhangyu-data/ds-mm-gcn-output/
...
deepspeed main.py --max_seq_len 4096 \
    ...
    --per_device_train_batch_size 12 --per_device_eval_batch_size 2 --deepspeed \
    --output_dir $OUTPUT \
